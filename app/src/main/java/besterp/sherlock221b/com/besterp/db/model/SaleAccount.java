...
// KEEP INCLUDES END
/**
 * Entity mapped to table "SALE_ACCOUNT".
 */
public class SaleAccount {

    private Long id;
    private int saleAccountNumber;
    private double saleAccountPrice;
    private double saleAccountTotal;
    /** Not-null value. */
    ...
    private transient SaleAccountDao myDao;
    ...
    public SaleAccount(Long id) {
        this.id = id;
    }

    public SaleAccount(Long id, int saleAccountNumber, double saleAccountPrice, double saleAccountTotal, java.util.Date saleDate, String desc, boolean isDelete, java.util.Date crtTime, java.util.Date updateTime, Long productId, Long standardId, Long customId) {
        this.id = id;
        this.saleAccountNumber = saleAccountNumber;
        this.saleAccountPrice = saleAccountPrice;
        this.saleAccountTotal = saleAccountTotal;
    ...
    public void __setDaoSession(DaoSession daoSession) {
        ...
        myDao = daoSession != null ? daoSession.getSaleAccountDao() : null;
    }
    ...
    public int getSaleAccountNumber() {
        return saleAccountNumber;
    }

    public void setSaleAccountNumber(int saleAccountNumber) {
        this.saleAccountNumber = saleAccountNumber;
    }

    public double getSaleAccountPrice() {
        return saleAccountPrice;
    }

    public void setSaleAccountPrice(double saleAccountPrice) {
        this.saleAccountPrice = saleAccountPrice;
    }

    public double getSaleAccountTotal() {
        return saleAccountTotal;
    }

    public void setSaleAccountTotal(double saleAccountTotal) {
        this.saleAccountTotal = saleAccountTotal;
    }
